...
# ======== SIMULATED BACKTEST ========
def run_simulated_backtest(exchange: ExchangeInterface) -> Dict:
...
def handle_exchange_downtime(state: BotState, downtime_start: Optional[float]) -> Tuple[bool, Optional[float]]:
