...
class AdvancedConfig:
    def __init__(self):
        ...
        self.base_grid_step_percent: float = float(os.getenv("BASE_GRID_STEP_PERCENT", 1.0))  # Cập nhật thành 1.0%
...
class EnhancedSmartGridManager:
    ...
    async def place_grid_orders(self, current_price: float, exchange: 'ExchangeInterface') -> None:
        ...
        quantity = round(quantity - (quantity % step_size), 6)  # Làm tròn đến 6 chữ số thập phân
    ...
    async def place_order(self, side: str, order_type: str, quantity: float, price: float = None) -> Dict:
        try:
            ...
            return await self.client.create_order(
                ...
                price=price  # Đã kiểm tra nên không cần điều kiện
            )
        except Exception as e:
