...
class AdvancedConfig:
    def __init__(self):
        ...
        self.grid_rebalance_interval = int(os.getenv("GRID_REBALANCE_INTERVAL", 120))
        self.min_grid_levels = int(os.getenv("MIN_GRID_LEVELS", 5))
        self.max_grid_levels = int(os.getenv("MAX_GRID_LEVELS", 20))
        self.base_grid_step_percent = float(os.getenv("BASE_GRID_STEP_PERCENT", 0.2))  # Giảm từ 0.3 xuống 0.2
...
async def update_dashboard(n_intervals):
