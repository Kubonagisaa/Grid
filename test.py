...
import dash
from dash import dcc, html, Output, Input, dash_table  # Sử dụng cú pháp mới cho dash_table
import dash_auth
...
if __name__ == "__main__":
    async def main():
        # Nếu PAPER_TRADING=True và LIVE_PAPER_TRADING=True, dùng PaperTradingExchange
        ...
        print("Khởi động live paper trading với giá thị trường cập nhật mỗi 1 giây ...")
