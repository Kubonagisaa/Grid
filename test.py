...
class AdvancedConfig:
    def __init__(self):
        ...
        self.grid_rebalance_interval = int(os.getenv("GRID_REBALANCE_INTERVAL", 60))  # Giảm từ 120 xuống 60
        self.min_grid_levels = int(os.getenv("MIN_GRID_LEVELS", 5))
        self.max_grid_levels = int(os.getenv("MAX_GRID_LEVELS", 12))  # Giảm từ 20 xuống 12
        self.base_grid_step_percent = float(os.getenv("BASE_GRID_STEP_PERCENT", 0.2))  # Đảm bảo lưới dày hơn
