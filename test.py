...
class BotState:
    ...
    async def process_events(self) -> None:
        ...
        # Kiểm tra sức khỏe sàn trước khi giao dịch (khôi phục từ mã gốc)
        ...
        # Kiểm tra vốn sau giao dịch (từ mã mới)
        ...
        # Gửi báo cáo Telegram theo tần suất tùy biến nếu cần (từ mã mới)
...
async def send_telegram_alert(message: str, parse_mode: str = "Markdown", reply_markup: dict = None) -> None:
    ...
    # Khôi phục xử lý lỗi chi tiết từ mã gốc
    try:
...
class ExchangeInterface(ABC):
    ...
    # Khôi phục health_check từ mã gốc
    ...
    # Khôi phục start_websocket từ mã gốc
...
# Khôi phục rebalance_loop từ mã gốc
