...
class EnhancedSmartGridManager:
    def __init__(self):
        ...
        # Nếu cần, bạn có thể thêm thuộc tính toàn cục để kiểm soát cooldown/retry đặt lệnh
...
class BotState:
    ...
    async def process_events(self) -> None:
        ...
        # Gọi đặt grid orders ngay khi cập nhật giá, đảm bảo 3 lệnh static được đặt sớm
...
def calculate_sharpe_ratio(returns: List[float], risk_free_rate: float = 0.0) -> float:
    ...
    return avg_excess_return / std_return if std_return != 0 else 0.0
...
# Nếu cần chạy trực tiếp, bạn có thể gọi main() ở đây.
# Ví dụ:
# if __name__ == "__main__":
#     exchange_manager = ExchangeManager()
#     loop = asyncio.get_event_loop()
#     loop.run_until_complete(exchange_manager.exchanges["paper_trading"].run_paper_trading())